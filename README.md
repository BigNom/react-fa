...
git push origin master https://github.com/BigNom/react-fa.git
...
When you are complete with your feature it is merged back into your develop branch
```sh
git checkout -b feature/redux develop
```
